...
*I could definitely add more notes to the guitar but to really improve on the project, maybe I could've used other ways to modulate the pitch, for example by using the accelerometer on the board or maybe even an ultrasonic distance sensor instead.
